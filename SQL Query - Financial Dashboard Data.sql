...
COPY cc_detail
FROM 'E:\DA\Projects\credit cardcredit_card.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'E:\DA\Projects\credit cardcustomer.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cc_detail
FROM 'E:\DA\Projects\credit cardcc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'E:\DA\Projects\credit cardcust_add.csv' 
DELIMITER ',' 
CSV HEADER;
